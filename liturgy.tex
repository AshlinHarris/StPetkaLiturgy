...
\ifIncludeMusic
\HymnFullPage{First_Antiphon.sub}
\else
\begin{paracol}{2}
...
\ifIncludeMusic
\HymnFullPage{Second_Antiphon.sub}
\else
\begin{paracol}{2}
...
\ifIncludeMusic
\HymnFullPage{Third_Antiphon.sub}
\else
\begin{paracol}{2}
...
%\cleardoublepage
\clearpage
\HymnFullPage{Paraskeva_Tropar.sub}
\HymnFullPage{Paraskeva_Kondak.sub}
\HymnFullPage{Theotokos_Kondak.sub}
%\cleardoublepage
\clearpage
\else
\begin{paracol}{2}
...
\HymnFullPage{Thrice_Holy_Hymn.sub}
\else
...
\ifIncludeMusic
\HymnFullPage{Cherubic_Hymn_1.sub}
\else
...
\ifIncludeMusic
\HymnFullPage{Cherubic_Hymn_2.sub}
\else
...
\ifIncludeMusic
\HymnFullPage{It_Is_Truly_Meet.sub}
\HymnFullPage{All_Creation_Rejoices.sub}
\HymnFullPage{Zadostoinik_Pascha.sub} % a hymn for Pascha (between Easter and Pentecost)
\else
...
%\HymnFullPage{Hvalite.sub}
\begin{HymnPartPage}\lilypondfile[quote, noindent, line-width=8.000000\in]{HYMNS_DIRECTORY/Hvalite.sub.ly}\end{HymnPartPage}
	\HymnFullPage{Raduytesya_Pravednii.sub}
\HymnFullPage{Under_Thy_Grace.sub}
\HymnFullPage{Chashu.sub}
\HymnFullPage{In_Eternal_Memory.sub}
\HymnFullPage{V_Pamjat_Vjechnuju.sub}
%TODO: this hymn might take 2 pages with Latin lyrics
\HymnFullPage{Nynje_sily_nebsnyja.sub}
%\cleardoublepage
\clearpage
\fi
...
\begin{HymnPartPage}\lilypondfile[quote, noindent, line-width=8.000000\in]{HYMNS_DIRECTORY/Telo_Hristovo_1.sub.ly}\end{HymnPartPage}
	\HymnFullPage{Telo_Hristovo_2.sub}
\HymnFullPage{Vkusite_i_vidite.sub}
\else
...
\ifIncludeMusic
\HymnFullPage{Let_our_mouths_be_filled.sub}
\else
...
%\HymnFullPage{HYMNS_DIRECTORY/Blessed_is_the_Name.sub}
\else
...
%TODO: mention that this is for the 3rd Sunday of Lent
\HymnFullPage{To_Thy_Cross.sub}

%TODO: mention that this replaces "O tebje..." on Annunciation day
\HymnFullPage{Zadostoinik_Annunciation.sub}

\HymnFullPage{V_Nedelu_Vani.sub} % a hymn for Palm Sunday
\HymnFullPage{Prichasten.sub} % a communion hymn for Palm Sunday

%\HymnFullPage{Zadostoinik_Pascha.sub} % a hymn for Pascha

\HymnFullPage{Da_Molchit.sub}
\HymnFullPage{Voskreseniye_Tvoye.sub}

\HymnFullPage{Pentecostal_Week.sub}
\HymnFullPage{Zadostoinik_Pentecost.sub}

\HymnFullPage{Ascension_hymn.sub}

\HymnFullPage{Flesh_Asleep.sub}

%\HymnFullPage{Great_Litany.sub}

%TODO: this hymn does not work without Latin lyrics
\HymnFullPage{Ton_Despotin.sub}

\HymnFullPage{Vjechnaya_Pamjat.sub}
\HymnFullPage{Memorial.sub}
\HymnFullPage{blazheni.sub}
\HymnFullPage{Memorial_Kondak.sub}
